...
If data is not gridded, documentation and example code should explain how a user can achieve a similar effect, This might include using “get range” on a Cloud Optimized GeoTIFF (COG) file, returning subsets of a Zarr store, plus guidance on merging data (dealing with overlapping data or filling gaps).
